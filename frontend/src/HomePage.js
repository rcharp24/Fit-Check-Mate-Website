...
const HomePage = () => {
  ...
  return (
    ...
    <div>
        ...
        {/* Main Content */}
        <Container fluid className="home-page-container vh-100 d-flex flex-column justify-content-center align-items-center checkered-background overflow-auto transparent-centered-container">
          {/* Title Section */}
